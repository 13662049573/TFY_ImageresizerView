...
@interface TFY_ImageresizerSlider ()
...
@implementation TFY_ImageresizerSlider {
    CGFloat _baseWH;
    CGFloat _bigWH;
    CGFloat _halfBaseWH;
    CGFloat _halfBigWH;
...
- (void)setSliding:(BOOL)sliding {
    ...
    [self.thumbLayer tfy_addBackwardsAnimationWithKeyPath:@"path" fromValue:(id)self.thumbLayer.path toValue:path timingFunctionName:kCAMediaTimingFunctionEaseIn duration:0.15];
    [CATransaction begin];
